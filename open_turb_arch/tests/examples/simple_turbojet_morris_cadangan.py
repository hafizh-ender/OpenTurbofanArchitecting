...
if __name__ == '__main__':
    ...
    save_folder = 'results_latest_morris_9'
    ...
    active_dv_ranges = [
            ...
            # [1.8, 3.6], # fpr
            # [20., 85.], # opr
            # [0.05, 0.15], # pr_compressor_ip
            
            # [0.1, 0.9], # pr_compressor_lp
            
            # [12000., 20000.], # rpm_shaft_hp
            # [2000., 12000.], # rpm_shaft_ip 
    ...
    X_samples = morris_sample.sample(problem, N=50, num_levels=4, optimal_trajectories=None)
    ...
    def run_my_model(X):
        ...
        for i, x in enumerate(X):
            ...
            # architecting_problem.analysis_problem.design_condition.balancer._init_turbine_pr = (x_dict['opr'])**(0.45)
            ...
            dv = [
                3.11309372,# x_dict['bpr'],     # BPR
                3.35042243,# x_dict['fpr'],     # FPR
                82.93060324,# x_dict['opr'],    # OPR
                0.0819508208,# x_dict['pr_compressor_ip'],             # % of IPC PR
                
                0,              # % of LPC PR
                10000,# x_dict['rpm_shaft_hp'],          # HP Shaft RPM
                5000,# x_dict['rpm_shaft_ip'],          # IP Shaft RPM
            ...
            if 'NaN' in metrics:
                ...
                architecting_problem.analysis_problem.design_condition.balancer._init_mass_flow = 100.0
